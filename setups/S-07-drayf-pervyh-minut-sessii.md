...
та, что закрывается в 09:31 ET. Решение принимается на закрытии минуты 3
(09:33 ET). Нужны 30 непрерывных закрытых минут до неё — это предрыночные
...
- **Стоимость выбора.** Посчитаны все 675 конфигураций (3 инструмента × 15 минут
  ...
  годам **среди всех** даёт +$204 150 при просадке $55 615 и 13 прибыльных годах
...
3. Проверка на данных, которых правило не видело: другой поставщик минут или
   период после 2026-05-04 под замороженным правилом v1. Только это даст
   независимое подтверждение, которого сейчас нет.
